...
"[project]/src/app/api/bot-data/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getOrderBookData(botId) {
    try {
        ...
        const orderBookPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(baseDir, `${botId}-orderbook.json`);
...
async function getBalanceData(botId) {
    try {
        // In a real implementation, this would read from actual log files or a database
        const baseDir = process.cwd().replace(/\\fe$/, '');
        const balancePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(baseDir, `${botId}-balance.json`);
        // Check if the file exists
...
async function getTransactionHistory(botId) {
    try {
        // In a real implementation, this would read from actual log files or a database
        const baseDir = process.cwd().replace(/\\fe$/, '');
        const transactionPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(baseDir, `${botId}-transactions.json`);
        // Check if the file exists
...
async function getPriceHistory(botId) {
    try {
        // In a real implementation, this would read from actual log files or a database
        const baseDir = process.cwd().replace(/\\fe$/, '');
        const historyPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(baseDir, `${botId}-price-history.json`);
        // Check if the file exists
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__61944e._.js.map